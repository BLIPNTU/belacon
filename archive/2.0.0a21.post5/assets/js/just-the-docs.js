...
function initSearch() {
  ...
  request.open('GET', '/belacon/archive/2.0.0a21/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/belacon/archive/2.0.0a21/assets/css/just-the-docs-' + theme + '.css');
}
